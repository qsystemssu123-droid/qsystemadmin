...
export default function Clinic({
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 animate-fade-in transition-all duration-300">
      <div className="flex flex-col gap-6">
        {/* Now Serving Card */}
        <div className="bg-white p-6 rounded-2xl shadow-xs border border-slate-200 text-center flex flex-col items-center justify-between transition-all duration-300 hover:shadow-md hover:border-purple-200 transform hover:-translate-y-0.5 group">
          <div className="w-full">
            ...
            {currentServing ? (
              <div className="flex flex-col items-center animate-fade-in">
                <span className="text-5xl font-black text-purple-600 my-2 font-mono transition-transform duration-300 group-hover:scale-105">
                ...
                <span className="inline-block px-2.5 py-0.5 rounded-md text-xs font-semibold bg-purple-50 text-purple-700 border border-purple-100 my-1 transition-transform duration-200 hover:scale-105">
                    ...
                    {currentServing.priorityImageUrl && (
                      <div>
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 text-xs font-semibold bg-slate-100 hover:bg-slate-200 text-slate-700 px-3 py-1.5 rounded-lg transition-all duration-200 hover:scale-105 active:scale-95 border border-slate-300 shadow-xs"
                        >
              ...
              <div className="py-12 animate-fade-in">
                <Users className="w-12 h-12 text-slate-300 mx-auto mb-2 transition-transform duration-300 hover:scale-110" />
          ...
          {currentServing && (
            <div className="flex items-center gap-2 mt-6 w-full justify-center">
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-1.5 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold py-2.5 px-4 rounded-xl transition-all duration-300 hover:shadow-md transform hover:-translate-y-0.5 active:scale-95 text-xs"
              >
        ...
        <div className="bg-white p-6 rounded-2xl shadow-xs border border-amber-200/60 flex flex-col justify-between transition-all duration-300 hover:shadow-md hover:border-amber-300 transform hover:-translate-y-0.5">
          <div>
            <h2 className="text-lg font-bold text-slate-900 mb-1 flex items-center justify-between">
              <span className="flex items-center gap-2">
                <ShieldAlert className="w-5 h-5 text-amber-600 transition-transform duration-300 hover:rotate-12" />
                Priority Lineup ({officeName})
              </span>
              <span className="text-xs font-semibold bg-amber-50 text-amber-700 px-2 py-1 rounded-lg border border-amber-200 transition-transform duration-200 hover:scale-105">
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <span className="font-mono font-bold text-slate-900 bg-white px-2.5 py-1 rounded-md border border-slate-200 text-xs shadow-2xs transition-transform duration-200 hover:scale-105">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="inline-flex items-center gap-1 text-emerald-700 hover:text-emerald-800 font-semibold text-xs bg-emerald-50 hover:bg-emerald-100 px-2.5 py-1.5 rounded-lg border border-emerald-200 transition-all duration-200 hover:scale-105 active:scale-95 shadow-2xs"
                        ...
                        <button
                          ...
                          className="inline-flex items-center gap-1 text-rose-700 hover:text-rose-800 font-semibold text-xs bg-rose-50 hover:bg-rose-100 px-2.5 py-1.5 rounded-lg border border-rose-200 transition-all duration-200 hover:scale-105 active:scale-95"
                          title="Reject"
                        >
                    ...
                    <div className="flex items-center justify-between pt-2 border-t border-amber-200/50 mt-1">
                      ...
                      {item.priorityImageUrl && (
                        <button
                          ...
                          className="inline-flex items-center gap-1 text-xs font-semibold bg-white hover:bg-slate-100 text-slate-700 px-2.5 py-1 rounded-md border border-slate-300 shadow-2xs transition-all duration-200 hover:scale-105 active:scale-95"
                        >
      ...
      {/* Upcoming Queue Card */}
      <div className="bg-white p-6 rounded-2xl shadow-xs border border-slate-200 flex flex-col justify-between h-full transition-all duration-300 hover:shadow-md transform hover:-translate-y-0.5">
        <div>
          <h2 className="text-lg font-bold text-slate-900 mb-4 flex items-center justify-between">
            <span>Upcoming Queue ({officeName})</span>
            <span className="text-xs font-semibold bg-slate-100 text-slate-600 px-2 py-1 rounded-lg transition-transform duration-200 hover:scale-105">
